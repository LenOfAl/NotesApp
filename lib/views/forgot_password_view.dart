...
import 'package:comingsoon/utilities/dialogs/password_reset_email_sent_dialog.dart';
        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            await showErrorDialog(context,
                'We could not process your request. Please make sure you are a registered user. If not register now by going back');
          }
        }
      },
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                  'If you forgot you password, simply enter you email and we will send you a reset password mail'),
              TextField(
